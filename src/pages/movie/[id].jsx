...
function Details() {
  ...
  const fetchVideo = async () => {
    ...
    const trailer =
      ...
      data?.results?.filter((movie) => movie.name === "Official Trailer");
    if (trailer.length > 0) {
              ...
              <div className="mt-5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {movieDetails?.credits?.cast.slice(0, 6).map((c) => (
                    <div className="flex flex-col gap-3 bg-gray-700 p-2 rounded-md">
                ...
                <div className="grid grid-cols-2 gap-3">
                  {movieDetails?.credits?.crew.slice(0, 6).map((c) => (
                    <div className="flex flex-col gap-3 bg-gray-700 p-2 rounded-md">
